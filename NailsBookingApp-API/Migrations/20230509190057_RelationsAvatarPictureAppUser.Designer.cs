...
namespace NailsBookingApp_API.Migrations
{
    ...
    [Migration("20230509190057_RelationsAvatarPictureAppUser")]
    partial class RelationsAvatarPictureAppUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NailsBookingApp_API.Models.AvatarPicture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NailsBookingApp_API.Models.POSTS.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NailsBookingApp_API.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime?>("PassResetExpirationDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("NailsBookingApp_API.Models.POSTS.Comment", b =>
                {
                    b.HasOne("NailsBookingApp_API.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("NailsBookingApp_API.Models.ApplicationUser", b =>
                {
                    b.HasOne("NailsBookingApp_API.Models.AvatarPicture", null)
                        .WithMany()
